...
import com.mobotechnology.bipinpandey.retrofit_handdirty.model.Results;
...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.EmployeeViewHolder> {
    ...
    public NoticeAdapter(ArrayList<Results> dataList , RecyclerItemClickListener recyclerItemClickListener) {
    ...
    public void onBindViewHolder(EmployeeViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.txtNoticeBrief.setText(dataList.get(position).getGeo_facet());
        holder.txtNoticeFilePath.setText(dataList.get(position).getByline());
